          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 20,),
                Text("Email : alamin35-449@diu.edu.bd",style: TextStyle(color: Color(0xFF949494),fontSize: 16),),
              ],
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                ...
                SizedBox(width: 20,),
                Text("Phone No : +01799288548",style: TextStyle(color: Color(0xFF949494),fontSize: 16),),
              ],
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                ...
                SizedBox(width: 20,),
                Text("Date of Birth : 01/02/1999",style: TextStyle(color: Color(0xFF949494),fontSize: 16),),
              ],
            ),
            SizedBox(height: 10,),
            Row(
